...
export default function CompanyClientJobsPage() {
  ...
  useEffect(() => {
    async function loadData() {
      ...
      try {
        ...
        const res = await fetch(`/api/client/jobs?companyId=${companyId}`, { cache: "no-store" });
      ...
      <div className="space-y-6">
        ...
        <div className="bg-amber-500 text-white py-3 px-4 rounded-lg text-center font-semibold shadow-lg">
          <div className="flex items-center justify-center gap-2">
            ...
            <span>プレビューモード - {companyName} - 求人一覧</span>
          </div>
        </div>
